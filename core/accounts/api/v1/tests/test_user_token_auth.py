...
def test_login_with_token_with_username_for_active_user_without_token_in_db(
    client, active_user
):
...
@pytest.mark.django_db
def test_login_with_token_by_username_for_active_user_without_token_in_db(
    client, active_user
):
    username_email, password = active_user.username, "testpassword123"
    url = reverse("account:api-v1:token-login")
...
@pytest.mark.django_db
def test_login_with_token_by_username_for_active_user_with_token_in_db(
    client, active_user_with_token
):
...
@pytest.mark.django_db
def test_login_with_token_by_email_for_active_user_without_token_in_db(
    client, active_user
):
...
@pytest.mark.django_db
def test_login_with_token_by_email_for_active_user_with_token_in_db(
    client, active_user_with_token
):
    active_user = active_user_with_token[0]
    username_email, password = active_user.email, "testpassword123"
...
def test_login_with_token_by_username_with_invalid_credentials(
