...
#         url = reverse('todo:api-v5:task-detail', kwargs={'slug':task.slug})
#         response = client.get(path=url)
#         assert response.status_code == 200
...
#     user = user1_with_tasks
#     client.force_authenticate(user)
#     url = reverse('todo:api-v5:task-detail', kwargs={'slug':'not-available'})
#     response = client.get(path=url)
...
#     number_of_tasks_for_this_user = len(user.tasks.all())
#     url = reverse('todo:api-v5:task-detail', kwargs={'slug':'edit-test'})
#     data = create_task_data(title, description, status)
...
#     client.force_authenticate(user)
#     number_of_tasks_for_this_user = len(user.tasks.all())
#     url = reverse('todo:api-v5:task-detail', kwargs={'slug':'unavailable'})
